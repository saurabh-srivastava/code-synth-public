# verina_basic_43 — sumOfFourthPowerOfOddNumbers

VERINA-basic task ported to this repo's proof-theoretic synthesizer and **faithfully verified** (Z3 + Lean, 1 `.solved.lean` proof(s)).
...
Reproduce: `python benchmarks/verina/verina_basic_43/problem.py`
