"""negate_array — Phase X corpus benchmark.

Pointwise negation: B[k] = -A[k].  Same shape as increment_array
but with a unary-minus transform.
...
PROBLEM = Problem(
    description = (
        ...
        "n (with n >= 0), populate B so that B[k] equals the negation "
        "of A[k] for every k in [0, n)."
    ),
