...
{witness, best_ub, best_ge}.  This subset is GENUINELY INVALID — it omits
...
private axiom kadane_sc2_invalid_witness :
    ∃ (n best i cur : Int) (A : Int → Int) (best' i' cur' : Int),
      ...
      (i' = (i + 1)) ∧
      ¬ (((∃ p : Int, ((0 ≤ p) ∧ (p ≤ (i' - 1)) ∧ ((sum_range A p i') = cur')))) ∧ ((∀ p q : Int, (((0 ≤ p) ∧ (p ≤ q) ∧ (q < i')) → ((sum_range A p (q + 1)) ≤ best')))) ∧ ((best' ≥ cur')))
