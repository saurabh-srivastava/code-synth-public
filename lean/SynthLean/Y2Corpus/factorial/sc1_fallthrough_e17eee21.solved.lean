/-
Companion to `sc1_fallthrough_e17eee21.failed.lean`.

VERDICT: VALID.  τ = {result=fact(i-1), i≥1}.  Same proof shape as
2095d30b but the goal only conjoins the two atoms in τ (no
i'≤n+1 carryover atom).
-/
