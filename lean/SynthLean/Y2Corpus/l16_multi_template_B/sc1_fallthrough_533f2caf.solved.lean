/-
T_B two-pointer sc1 helper, 5-atom τ.  Adds `left ≤ right + 1`
to the previous 4-atom version (needed for the new ranking
phi = right - left + 1 ≥ 0 to be τ-preserved at exit).
Proof structure identical to the 4-atom version.
-/
