/-
Companion to `sc1_fallthrough_e105abe6.failed.lean`.
...
theorem sc1_fallthrough_e105abe6_is_invalid :
    ∃ (n candidate i cnt : Int) (A : Int → Int),
      ((n ≥ 1) ∧ (∃ v : Int, ((count_eq A n v) > (n / 2)))) ∧ ((i ≤ n)) ∧
      ((i < n)) ∧ ¬ (((cnt = 0)) ∨ ((cnt > 0))) := by
  refine ⟨1, 0, 0, -1, (fun _ => 0), ?_, ?_ ,  ?_, ?_⟩
