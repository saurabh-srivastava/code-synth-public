...
theorem sc4_fallthrough
    ...
    (h_trans_i : i' = (i + 1)) :
    ((0 ≤ i')) ∧ ((i' ≤ n)) ∧ ((∀ v : Int, ((cnt' + (count_eq A i' candidate)) ≥ (count_eq A i' v)))) := by
    ...
    · intro v
      ...
      exact bm_inv_preserve_b1 A n i candidate cnt h_pre h_tau_2 ⟨h_lt, h_cnt_pos⟩ v
